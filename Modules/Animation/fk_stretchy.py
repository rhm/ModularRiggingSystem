...
DESCRIPTION="This module provides FK rotational controls for every joint in the blueprint it is installed on, along" \
            "with the ability to stretch each of the joint segments."
...
class FK_Stretchy(fk.FK):
    ...
    def match(self, *args):
        (blueprintJoints, fkControls) = fk.FK.match(self, args)
